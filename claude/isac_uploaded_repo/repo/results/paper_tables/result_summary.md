...
## Findings
- ProposedV2 vs Reactive: rate gain 0.0198, outage reduction 0.0285, beam-success gain 0.0450.
- Scene sweeps: across 16 comparable points, ProposedV2 beats or matches Reactive on outage at 16/16 points, on beam success at 16/16, on return at 10/16, and on rate at 6/16. The largest return deficits appear at `obs_noise=0.00`, `blocker_density=3.00`, `obs_noise=0.02`, which points to over-conservative fallback usage in easy scenes and at the hardest density setting.
